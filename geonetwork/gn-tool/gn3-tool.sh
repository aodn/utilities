...
get_all_records() {
    ...
    python ./get-uuids.py "$gn_addr/srv/eng/xml.search?fast=index&_isHarvested=$harvested_records_arg&from=1&to=2000" $gn_user_arg $gn_password_arg $gn_xsrftoken_arg
